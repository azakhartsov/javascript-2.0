...
function f5() {
         document.querySelector('.out-5').innerHTML = document.querySelector('.out-4').classList.contains('bg-orange');
}
...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = count.length;
}
...
function f14() {
    ...
    document.querySelector('.out-14').appendChild(div14);
}
...
function f18() {
    let div18 = document.querySelector('.p-18').getAttribute('data-b');
    document.querySelector('.out-18').innerHTML = div18;
}
...
function f19() {
    let div19 = document.querySelectorAll('.p-19');
    let out = '';

    for (let i = 0; i < div19.length; i++) {
        out += div19[i].getAttribute('data-b') + ' ';
    }
