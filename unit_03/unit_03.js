...
function f1(){
   ...
   let compare = input.value == 4;

   document.querySelector('.out-1').innerHTML = compare;
}
...
function f3(){
   ...
   if (input1 > input2) {
      document.querySelector('.out-3').innerHTML = input1;
   }
   else {
      document.querySelector('.out-3').innerHTML = input2;
   }
}
...
function f4(){
   ...
   let age = 2021 - input.value; // можно получить текущий год через Date.getFullYear()
...
function f7(){
   ...
   document.querySelector('.out-7').innerHTML = input1 ** input2;
}
...
function f8(){
   let selector = +document.querySelector('.s-8').value;
...
function f10(){
   let selector = document.querySelector('.s-100').value;
   document.querySelector('.out-10').innerHTML = selector;
}
...
function f11(){
   let selector = document.querySelector('.s-110');

      document.querySelector('.out-11').innerHTML = selector.value;
}
...
function f14(){
   ...
   let x = document.querySelector('.s-143').value;
...
function f15(){
   ...
   let x = document.querySelector('.s-153').value;
