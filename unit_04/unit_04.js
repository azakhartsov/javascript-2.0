...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = input.value;
}
...
function f7() {
    ...
    document.querySelector('.out-71').innerHTML = input.value;
...
function f8() {
    let tag = '<div class="js2">new div</div>';
    document.querySelector('.out-8').innerHTML += tag;
}
...
function f10() {
    ...
    document.querySelector('.out-10').style.background = colour.value;
}
...
function f11() {
    let colour1 = document.querySelector('.i-111');
    let colour2 = document.querySelector('.i-112');

    colour2.value = colour1.value;
}
...
function f13() {
    ...
    document.querySelector('.out-13').innerHTML = range.value;
}
...
function f15() {
    ...
    document.querySelector('.t-15').innerHTML = input.value;
    document.querySelector('.out-15').innerHTML = input.value;
...
function f16() {
    ...
    let selector = document.querySelector('.s-16');
    document.querySelector('.out-16').innerHTML = selector.value;
}
...
function f17() {
    let selector = document.querySelector('.s-17');
    document.querySelector('.out-17').innerHTML = selector.value;
}
...
function f18() {
    let selector = document.querySelector('.s-18');
    document.querySelector('.i-18').value = selector.value;    
}
...
function f19() {
 let text = document.querySelector('.out-19').innerHTML;
...
function f20() {
    let selector1 = document.querySelector('.s-201');
    let selector2 = document.querySelector('.s-202');
    selector2.value = selector1.value;
