...
const f7 = () => { 
    ...
    let set1 = new Set(input);

    if (set1.size == input.length && set1.size > 6 ) {
...
// потому что [1] не равен [1] это два разных массива с одинаковыми элементами. Поэтому добавляются оба.
