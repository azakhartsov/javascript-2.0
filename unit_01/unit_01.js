...
document.querySelector('div.out-8').innerHTML = 'task-8'; // через точку я пишу class.
...
document.querySelector('div.out-16').innerHTML = x1 + x2; // число 5 преобразовалось в строку и с помощью конкантинации через "+" две строки 'склеились'
