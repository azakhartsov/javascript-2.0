...
document.querySelector('.out-4').textContent = e1 + f1; // этом случае происходит конкатинация строковой переменной 3 и числа 5. В итоге получается 3 и 5, 35.

// Task 5.
// Создайте две переменные e2 = 3 и f2 = 0. Выведите на страницу  в .out-5 результат деления e2 на f2.

let e2 = 3; //числовая переменная
let f2 = 0; //числовая переменная

document.querySelector('.out-5').textContent = e2 / f2; // математическое деление на 0 возвращает infinity.
...
document.querySelector('.out-6').textContent = e3 + f3; // конкатинация
...
document.querySelector('.out-7').textContent = e4 * f4; // возвращает not a number, поскольку f4 это строковая переменная
...
function t8() {
    ...
    // тут выводим
    document.querySelector('div.out-8').innerHTML = data;
}
...
function t9() {
    let input = document.querySelector('input.i-9'); // хватаюсь через input за мою строку ввода
    document.querySelector('div.out-9').innerHTML = input.value; // хватаюсь за мой out и передаю туда введенное в input значение value
    input.value = '';
}
...
function t10() {
    ...
    document.querySelector('div.out-10').innerHTML = input.value * 20;
}
...
function t11() {
    ...
    document.querySelector('.out-11').innerHTML = input.value + 55;
}
...
function t13() {
    let inputA = document.querySelector('input.i-13-1');
    let inputB = document.querySelector('input.i-13-2');
    let a = +inputA.value;
    let b = +inputB.value;
...
function t16() {
    let inputA = document.querySelector('.i-16-1');
    let inputB = document.querySelector('.i-16-2');

    document.querySelector('.out-16').innerHTML = inputA.value + inputB.value;
}
...
function t17() {
    ...
    document.querySelector('.out-17-1').innerHTML = +a; // преобразование в число
    document.querySelector('.out-17-2').innerHTML = parseInt(a, 10); // преобразование в intege,  в этом случае в десятичное
    document.querySelector('.out-17-3').innerHTML = Number(a); // преобразует в number  c плавающей запятой
}
...
function t19() {
    ...
    document.querySelector('.out-19').innerHTML = parseInt(a) + parseInt(b);
}
