...
let ar2 = ['value', 600, false, 'motorcycle']; // переменную обьявляем здесь!!!!
...
let ar3 = [1,56,2,7,87,3, true]; // переменную обьявляем здесь!!!!
...
let ar6 = ['Andrew', 'Libra', 19, 'October'];
...
function f20() {
    ...
    // alternative: let sum = (acc,i) => acc + i;
}
